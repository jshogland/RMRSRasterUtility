    ...
    public partial class frmTransportationCost : Form
    {
        ...
        private void populateCmb()
        {
            ...
            foreach (string s in frmHlp.FeatureDictionary.Keys)
            {
                ...
                if (geoType == ESRI.ArcGIS.Geometry.esriGeometryType.esriGeometryPolygon)
                {
                    cmbBarrier.Items.Add(s);
                }
            }
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            IWorkspace wks = geoUtil.OpenRasterWorkspace(wksStr); //geoUtil.OpenWorkSpace(wksStr);
            if (wks == null)
            {
                MessageBox.Show("A valid file raster workspace must be specified before executing");
                return;
            }
        ...
        {
            ESRI.ArcGIS.Catalog.IGxObjectFilter flt = new ESRI.ArcGIS.Catalog.GxFilterFileFolderClass();
            string[] nm;
