...
namespace esriUtil
{
    public class imageAnalysisUtil
    {
        ...
        private IGeoProcessorResult gpExecute(ESRI.ArcGIS.Geoprocessor.IGPProcess process)
        {
        ...
        public string calcBandStats(object inRasterPath, string outStats)
        {
            ...
            ESRI.ArcGIS.SpatialAnalystTools.BandCollectionStats bcStats = new ESRI.ArcGIS.SpatialAnalystTools.BandCollectionStats();
        ...
        public string isoClusterUnSupervised(object inRasterDset, IWorkspace outWorkSpace, int numClasses, string outRstPath, string outSigPath)
        {
            ...
            try
            {
                ...
                ESRI.ArcGIS.SpatialAnalystTools.IsoClusterUnsupervisedClassification isoCls = new ESRI.ArcGIS.SpatialAnalystTools.IsoClusterUnsupervisedClassification();
        ...
        {
            ESRI.ArcGIS.SpatialAnalystTools.CreateRandomRaster cRndRst = new ESRI.ArcGIS.SpatialAnalystTools.CreateRandomRaster();
            string bnd = "";
        ...
        {
            ESRI.ArcGIS.SpatialAnalystTools.Float fl = new ESRI.ArcGIS.SpatialAnalystTools.Float();
        ...
        {
            ESRI.ArcGIS.SpatialAnalystTools.Negate ng = new ESRI.ArcGIS.SpatialAnalystTools.Negate();
        ...
        {
            ESRI.ArcGIS.SpatialAnalystTools.Ln ln = new ESRI.ArcGIS.SpatialAnalystTools.Ln();
        ...
        {
            ESRI.ArcGIS.SpatialAnalystTools.FocalStatistics fstats = new ESRI.ArcGIS.SpatialAnalystTools.FocalStatistics();
