...
namespace esriUtil
{
    public class rasterUtil
    {
        ...
        public IFunctionRasterDataset reSampleRasterFunction(object inRaster, double outCellSize,rstResamplingTypes ReSampleType=rstResamplingTypes.RSP_NearestNeighbor)
        {
